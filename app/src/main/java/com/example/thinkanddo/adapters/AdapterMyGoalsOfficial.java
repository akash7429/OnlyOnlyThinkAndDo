...
public class AdapterMyGoalsOfficial extends RecyclerView.Adapter<AdapterMyGoalsOfficial.MyHolder> {
    ...
    public AdapterMyGoalsOfficial(Context context, List<ModelGoalDescription> modelGoalDescriptionList) {
        ...
        public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.row_my_goal_offi, parent, false);
...
// view holder class
        ...
        class MyHolder extends RecyclerView.ViewHolder {
            ...
            public MyHolder(@NonNull View itemView) {
                ...
                gTimeTv = itemView.findViewById(R.id.gTimeTvo);
                gTitleTv = itemView.findViewById(R.id.goal_title_Tvo);
                gDescriptionTv = itemView.findViewById(R.id.goal_description_Tvo);
                moreBtn = itemView.findViewById(R.id.moreBtn);
                profileLayout = itemView.findViewById(R.id.goal_profileLayouto);
            }
        }
