...
import com.example.thinkanddo.adapters.AdapterMyGoalsOfficial;
...
public class MyGoalsActivityOfficial extends AppCompatActivity {
    ...
    AdapterMyGoalsOfficial adapterGoalDescription;
    String uID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_goals_official);
        ...
        recyclerView = findViewById(R.id.mygoalsofficialRecyclerView);
    ...
    private void loadGoals() {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(MyGoalsActivityOfficial.this);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    adapterGoalDescription = new AdapterMyGoalsOfficial(MyGoalsActivityOfficial.this, goalDescriptionList);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(MyGoalsActivityOfficial.this, "" + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void checkUserStatus(){
        ...
        if(user!=null){
            ...
            startActivity(new Intent(MyGoalsActivityOfficial.this,MainActivity.class));
            finish();
        }
    }
}
