...
import com.group.amplifate.adapters.AdapterComments;
import com.group.amplifate.models.ModelComment;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try{
            ...
            stream.flush();
            stream.close();
            uri= FileProvider.getUriForFile(this,"com.group.amplifate.fileprovider",file);
